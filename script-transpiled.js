...
fetch("https://www.omniva.lv/locations.json").then(function (response) {
...
function getCity(l) {
    var city;
    if (l.A3_NAME) city = l.A3_NAME;else if (l.A2_NAME) city = l.A2_NAME;else if (l.A1_NAME) city = l.A1_NAME;
    return city;
}
